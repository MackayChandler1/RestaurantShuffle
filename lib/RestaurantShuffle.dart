...
import 'package:restaurant_shuffle/pages/current_screen.dart';
import 'package:restaurant_shuffle/pages/filter_screen.dart';

class RestaurantShuffle extends StatelessWidget {
  const RestaurantShuffle({Key? key}) : super(key: key);
